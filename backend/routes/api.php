...
Route::post('/departments', [InventoryController::class, 'createDepartment']);
Route::put('/departments/{id}', [InventoryController::class, 'updateDepartment']);
Route::delete('/departments/{id}', [InventoryController::class, 'deleteDepartment']);
Route::get('/department-categories', [InventoryController::class, 'getDepartmentCategories']);
Route::get('/users', [InventoryController::class, 'getUsers']);
Route::post('/users', [InventoryController::class, 'createUser']);
Route::put('/users/{id}', [InventoryController::class, 'updateUser']);
Route::delete('/users/{id}', [InventoryController::class, 'deleteUser']);
